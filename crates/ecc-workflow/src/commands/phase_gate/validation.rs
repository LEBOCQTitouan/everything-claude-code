...
",
        ...
        let result =
            crate::commands::phase_gate::resolve::resolve_worktree_state_dir(&worktree_root.join("src/lib.rs").to_string_lossy());
        assert_eq!(
            result,
...
",
    ...
    fn resolve_worktree_stops_at_git_dir() {
        ...
        let result =
            crate::commands::phase_gate::resolve::resolve_worktree_state_dir(&repo_root.join("src/main.rs").to_string_lossy());
        assert_eq!(
            result, None,
    ...
    fn resolve_worktree_depth_limit() {
        ...
        let result = crate::commands::phase_gate::resolve::resolve_worktree_state_dir(&deep_path);
        assert_eq!(
            result, None,
