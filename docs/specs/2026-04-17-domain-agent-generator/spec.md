...
|---|----------|--------|--------|
| 1 | Scope boundaries | Include pipeline auto-injection | User |
| 2 | Bootstrap source | Require bounded-contexts.md | Recommended |
| 3 | Test strategy | 100% validation+injection, 80% content | Recommended |
| 4 | Performance | Parallel (3 concurrent) | User |
| 5 | Security | Read-only tools | Recommended |
| 6 | Injection pattern | Single Phase 0.7 per command | Recommended |
| 7 | Glossary | 3 new terms | Recommended |
| 8 | ADRs | Two (generation + injection) | Recommended |

### User Stories

| ID | Title | AC Count | Dependencies |
|----|-------|----------|--------------|
| US-001 | Domain Agent Generator Command | 9 | none |
| US-002 | Agent Body Content Standard | 6 | US-001 |
| US-003 | Validate agents/domain/ | 4 | none |
| US-004 | Pipeline Domain Context Injection | 7 | US-001,002,003 |
| US-005 | Staleness Detection | 3 | US-001 |
| US-006 | Discovery Skill | 4 | none |

### Adversary Findings

Verdict: PASS (user override after 3 CONDITIONAL rounds). Phase insertion points deferred to /design.
