...
- AC-001.4: Given a repository-wide grep for `ECC_WORKFLOW_BYPASS`, when executed, then matches exist only in files under `docs/specs/*/` and `docs/adr/*/` directories
