...
const evaluateScript = path.join(__dirname, '..', '..', '10-scripts', 'hooks', 'evaluate-session.js');
...
function runTests() {
  ...
  if (
    test('uses custom min_session_length from config file', () => {
      ...
      // The config path is: path.join(__dirname, '..', '..', '05-skills', 'continuous-learning', 'config.json')
  ...
  if (
    test('falls back to defaults when config file contains invalid JSON', () => {
      ...
      //   path.join(__dirname, '..', '..', '05-skills', 'continuous-learning', 'config.json')
      // where __dirname = scripts/hooks/ → config = repo_root/skills/continuous-learning/config.json
      const configPath = path.join(__dirname, '..', '..', '05-skills', 'continuous-learning', 'config.json');
