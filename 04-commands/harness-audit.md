...
- Inspect `07-hooks/hooks.json`, `10-scripts/hooks/`, and hook tests.
- Inspect `05-skills/`, command coverage, and agent coverage.
...
Top 3 Actions:
1) Add cost tracking hook in 10-scripts/hooks/cost-tracker.js
2) Add pass@k docs and templates in 05-skills/eval-harness/SKILL.md
