...
function runTests() {
  ...
  try {
    ...
    if (
      test('detects agents with frontmatter name', () => {
    ...
    if (
      test('returns empty for non-existent commands dir', () => {
    ...
    if (
      test('returns empty for non-existent skills dir', () => {
    ...
    if (
      test('detects skills with and without SKILL.md', () => {
    ...
    if (
      test('returns empty for non-existent rules dir', () => {
    ...
    if (
      test('detects rules grouped by subdirectory', () => {
    ...
    if (
      test('returns empty for non-existent settings.json', () => {
    ...
    if (
      test('detects hooks from settings.json', () => {
    ...
    if (
      test('handles malformed settings.json', () => {
    ...
    if (
      test('returns empty for non-existent CLAUDE.md', () => {
    ...
    if (
      test('extracts ## headings from CLAUDE.md', () => {
    ...
    if (
      test('returns complete detection result', () => {
    ...
    if (
      test('generates report for populated detection', () => {
        const result = detect(tmpDir);
    ...
    if (
      test('generates report for empty detection', () => {
