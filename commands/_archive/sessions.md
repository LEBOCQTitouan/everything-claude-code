...
```bash
node -e "
const sm = require((process.env.ECC_ROOT||require('path').join(require('os').homedir(),'.claude'))+'/dist/lib/session-manager');
const aa = require((process.env.ECC_ROOT||require('path').join(require('os').homedir(),'.claude'))+'/dist/lib/session-aliases');
