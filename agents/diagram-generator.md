...
If a marker and a manifest/auto-detected entry describe the same diagram (same type + same scope), prefer the marker (it has explicit placement in a doc file).
...
Diagrams Generated
  ...
  Auto-detected:    3
  Total:            6
  Files written:    docs/diagrams/ (4 new, 2 updated)
  Inline embedded:  2
```
...
- Never modify files without the `<!-- Generated by diagram-generator -->` header in `docs/diagrams/`
