...
; **self-evaluation** = post-PC evaluation step in /implement checking AC satisfaction, regression heuristics, and spec achievability via read-only pc-evaluator subagent (conditional: fix rounds > 0, integration/e2e, wave boundary)
